          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <Card className="glow-card bg-card/50 backdrop-blur-sm border-primary/20 overflow-hidden order-first lg:order-none">
              ...
              <CardContent className="space-y-6">
                ...
                {/* CSE Branch */}
                <div className="space-y-3 border-t border-primary/10 pt-6">
                  <h4 className="font-semibold text-lg text-neon-blue mb-4">CSE Branch</h4>

                  <div className="space-y-2">
                    <h5 className="text-sm font-medium text-neon-blue/80 px-2">Executive Members</h5>
                    <div className="max-h-48 overflow-y-auto pr-2 space-y-2">
                      {[
                        ...
                        <div key={index} className="p-2 bg-neon-blue/10 rounded border border-neon-blue/20">
                  ...
                  <div className="space-y-2">
                    <h5 className="text-sm font-medium text-foreground/70 px-2">Volunteers</h5>
                    <div className="max-h-40 overflow-y-auto pr-2 space-y-2">
                      {[
                        ...
                        <div key={index} className="p-2 bg-background/30 rounded border border-primary/10">
                ...
                {/* AI & DS Branch */}
                <div className="space-y-3 border-t border-primary/10 pt-6">
                  <h4 className="font-semibold text-lg text-neon-blue mb-4">AI & DS Branch</h4>
                ...
                {/* IT Branch */}
                <div className="space-y-3 border-t border-primary/10 pt-6">
                  <h4 className="font-semibold text-lg text-neon-blue mb-4">IT Branch</h4>
                ...
                {/* ECE Branch */}
                <div className="space-y-3 border-t border-primary/10 pt-6">
                  <h4 className="font-semibold text-lg text-neon-blue mb-4">ECE Branch</h4>
